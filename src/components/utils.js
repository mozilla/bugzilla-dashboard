...
export const getIconFromMime = (contentType) => {
  const [icon = 'file-o'] = Object.entries(MIMETYPE_ICONS).find(([, matches]) => matches.some(
...
export const parameterizeTask = task => merge(
  omit(
    [
      'taskGroupId',
      'routes',
...
export const urls = withRootUrl('https://taskcluster.net');
