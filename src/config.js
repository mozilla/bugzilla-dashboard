  ...
  reporteesMetrics: {
    ...
    assignedTrackedNightly: {
      ...
      parameterGenerator: mail => ({
        ...
        emailtype1: 'exact',
        resolution: '---',
        f1: 'cf_tracking_firefox69',
        o1: 'anyexact',
        v1: '+,blocking',
        f2: 'cf_status_firefox69',
        o2: 'equals',
        v2: 'affected',
      }),
    },
...
export const BZ_QUERIES = {
  ...
  unassignedBetaBugs: {
      ...
      parameters: {
          ...
          // landed
          f1: 'cf_tracking_firefox68', o1: 'anyexact',    v1: '+,blocking',
          f2: 'cf_status_firefox68',   o2: 'equals',      v2: 'affected',
  ...
  nightlyNewBug: {
      ...
      parameters: {
          ...
          f1: 'cf_status_firefox69',   o1: 'equals',       v1: 'affected',
          f2: 'OP',                    j2: 'OR',
          f3: 'cf_status_firefox68',   o3: 'equals',       v3: 'unaffected',
          f4: 'cf_status_firefox68',   o4: 'equals',       v4: '?',
          f5: 'cf_status_firefox68',   o5: 'equals',       v5: '---',
          f6: 'CP',
          f7: 'flagtypes.name',        o7: 'notsubstring', v7: 'needinfo',
          f8: 'cf_tracking_firefox69', o8: 'notequals',    v8: '-',
